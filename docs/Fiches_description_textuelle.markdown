...
- **Acteur principal** : Utilisateur non connecté, Utilisateur connecté  
- **Description** : Permet à l’utilisateur de consulter la liste de toutes les formations disponibles et de filtrer selon différents critères.  
- **Préconditions** : L’application est ouverte.  
- **Scénario principal** :  
  1. L’utilisateur sélectionne l’option pour afficher les formations.  
  2. Le système affiche la liste complète des formations.  
  3. L’utilisateur peut choisir de filtrer par type (présentiel, en ligne, mixte) ou rechercher un mot-clé.  
- **Extensions / Exceptions** :  
  - Aucun cours ne correspond aux filtres : le système affiche un message « Aucune formation trouvée ».
...
- **Description** : Permet d’ajouter ou retirer des formations avant de passer une commande.  
...
- **Préconditions** : L’utilisateur est authentifié et a déjà passé au moins une commande.  
- **Scénario principal** :  
